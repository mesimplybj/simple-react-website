...
import post2 from '../../assets/img/testimonial-2.jpg';
function Blog(props) {
    return (
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-img">
                                <a href="blog-single.html"><img src={post1} alt="" class="img-fluid" /></a>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <div class="post-author">
                                    <a href="#">
                                        <img src={post2} alt="" class="avatar rounded-circle" />
